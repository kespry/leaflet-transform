...
var _extMarkerExt = require('../../ext/MarkerExt');

var _extMarkerExt2 = _interopRequireDefault(_extMarkerExt);
...
var SimpleShape = _leaflet2['default'].Handler.extend({
	...
	_initMarkers: function _initMarkers() {
		...
		this.options.transforms.forEach((function (transform) {
			typeof transform === 'object' ? this.transforms.ui[transform.type.toLowerCase()].call(this, transform) : this.transforms.ui[transform.toLowerCase()].call(this);
		}).bind(this));
	},
	...
	_createMarker: function _createMarker(latlng, icon, dx, dy) {
		...
		var marker = new _extMarkerExt2['default'](latlng, {
			draggable: true,
			icon: icon,
			zIndexOffset: 10,
			dx: dx,
