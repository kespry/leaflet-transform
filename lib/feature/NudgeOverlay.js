...
exports['default'] = _leaflet2['default'].FeatureGroup.extend({
  ...
  initialize: function initialize(bounds, options) {
    ...
    this._overlays = {
      domain: new _layerSVGOverlay2['default'](options.url, bounds, options),
      range: new _layerSVGOverlay2['default'](options.url, bounds, options)
    };
  ...
  updateTransformEstimate: function updateTransformEstimate() {
    ...
    var transform = _nudged2['default'].estimate('TSR', domainPoints, rangePoints);
