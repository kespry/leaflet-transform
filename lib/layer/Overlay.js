...
exports.default = _leaflet2.default.Class.extend({
	...
	_zoomEnd: function _zoomEnd(evt) {
		...
		this._shift = this._map.latLngToLayerPoint(this._wgsOrigin)._subtract(this._wgsInitialShift.multiplyBy(this._scale2));
